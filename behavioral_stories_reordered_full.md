...
5. [Difficult Decision Under Pressure – Rollback](#6-difficult-decision-under-pressure--rollback)
6. [Balancing Speed vs Quality & Scope](#5-balancing-speed-vs-quality--scope)
7. [Working with Limited Information / Unclear Requirements](#12-working-with-limited-information--unclear-requirements)
8. [Handling Multiple Priorities & Tight Deadlines](#11-handling-multiple-priorities--tight-deadlines)
9. [Handling Conflict with UX / Design](#10-handling-conflict-with-ux--design)
10. [Cross-Team Collaboration – E-commerce Platform](#7-cross-team-collaboration--e-commerce-platform)
11. [Mentoring & Supporting Teammates](#8-mentoring--supporting-teammates)
12. [Failure & Learning – Missing E2E Coverage](#9-failure--learning--missing-e2e-coverage)
